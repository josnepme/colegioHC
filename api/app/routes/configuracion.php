  ...
  public static  function cargos()
  {
    ...
    switch ($opcion) {
      ...
      case 2:
        $cargo = Flight::request()->data->cargo;
        try {
          $db->runQuery("INSERT INTO cargos (cargo) VALUES (?)", [$cargo]);
          Flight::json(array(
            'mensaje' => 'ok'
          ), 200);
        } catch (Exception $e) {
      ...
      case 3:
        ...
        $cargo = Flight::request()->data->cargo;
        try {
          $db->runQuery("UPDATE cargos SET cargo = ? WHERE id = ?", [$cargo, $id]);
          Flight::json(array(
            'mensaje' => 'ok'
          ), 200);
        } catch (Exception $e) {
      ...
      case 4:
        $id = Flight::request()->data->id;
        try {
          $db->runQuery("DELETE FROM cargos WHERE id = ?", [$id]);
          Flight::json(array(
            'mensaje' => 'ok'
          ), 200);
        } catch (Exception $e) {
